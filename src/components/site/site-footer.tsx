  ...
  return (
    <footer className="border-t border-hairline py-12 md:py-16">
      <div className="shell">
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-hairline pt-6 text-[0.65rem] uppercase tracking-[0.14em] text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <span>© {new Date().getFullYear()} OMNIEL</span>
          <span>Early-stage / Pre-launch / Built in {location}</span>
        </div>
      </div>
    </footer>
  );
